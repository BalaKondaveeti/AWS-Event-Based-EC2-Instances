...
const s3client = new S3Client({
  ...
  credentials:{accessKeyId: 'AKIA47CRVLP3OP56FQ6I',
  ...
  const onsubmit = useCallback(async () => {
    ...
    if (selectedFile && inputText) {
      try {
        ...
        const response2 = await fetch(`https://myr0dmq7sc.execute-api.us-east-1.amazonaws.com/dev/invoke?text=${inputText}&bucket=filesaver-lamba-learn&s3key=${selectedFile.name}`, {
          method: 'POST',
          headers: {
